...
class DispatcherGenerator implements CallbackGenerator {
    ...
    private static final Type DISPATCHER =
      TypeUtils.parseType("com.github.drinkjava2.jbeanbox.cglib3_2_0.proxy.Dispatcher");
    private static final Type PROXY_REF_DISPATCHER =
      TypeUtils.parseType("com.github.drinkjava2.jbeanbox.cglib3_2_0.proxy.ProxyRefDispatcher");
