...
package com.github.drinkjava2.jbeanbox.springsrc;
...
public abstract class CollectionUtils {// NOSONAR
	...
	public static <A, E extends A> A[] toArray(Enumeration<E> enumeration, A[] array) {
		ArrayList<A> elements = new ArrayList<A>();// NOSONAR
		while (enumeration.hasMoreElements()) {
	...
	public static <E> Iterator<E> toIterator(Enumeration<E> enumeration) {
		return new EnumerationIterator<E>(enumeration);// NOSONAR
	}
	...
	public static <K, V> MultiValueMap<K, V> toMultiValueMap(Map<K, List<V>> map) {
		return new MultiValueMapAdapter<K, V>(map);// NOSONAR
	...
	public static <K, V> MultiValueMap<K, V> unmodifiableMultiValueMap(MultiValueMap<? extends K, ? extends V> map) {
		...
		Map<K, List<V>> result = new LinkedHashMap<K, List<V>>(map.size());// NOSONAR
	...
	private static class EnumerationIterator<E> implements Iterator<E> {
		...
		@Override
		public E next() {// NOSONAR
			return this.enumeration.nextElement();
		}

		@Override
		public void remove() throws UnsupportedOperationException {// NOSONAR
	...
	private static class MultiValueMapAdapter<K, V> implements MultiValueMap<K, V>, Serializable {
		...
		private final Map<K, List<V>> map;// NOSONAR
		...
		public void add(K key, V value) {
			...
			if (values == null) {
				values = new LinkedList<V>();// NOSONAR
		...
		public void set(K key, V value) {
			List<V> values = new LinkedList<V>();// NOSONAR
			values.add(value);
			this.map.put(key, values);
		}
		...
		public Map<K, V> toSingleValueMap() {
			LinkedHashMap<K, V> singleValueMap = new LinkedHashMap<K, V>(this.map.size());// NOSONAR
